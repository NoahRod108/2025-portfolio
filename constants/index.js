...
export const projects = [
  ...
  },
  {
    ...
    name: "Rest API Backend",
    desc: "A REST API backend built with Node.js, Express, and MongoDB. Includes user authentication with JWT and bcrypt password hashing, plus full CRUD for posts. You can test CRUD functionality with any API client.",
    img: backend,
    liveLink: "https://intro-backend-steel.vercel.app/",
    githubLink: "https://github.com/NoahRod108/intro-backend",
    tags: ["API", "REST", "Express.js", "Node.js", "MongoDB", "JWT"],
